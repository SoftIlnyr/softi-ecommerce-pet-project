package com.softi.productservice.testchangelog;
...
@ChangeLog(order = "001")
public class TestInitChangelog {
    ...
    public void initCategories(CategoryRepository categoryRepository) {
        ...
        Category tempCategoryOther = new Category();
        tempCategoryOther.setName("Other");
        categoryRepository.save(tempCategoryOther);
    }
